...
func main() {
	...
	flag.StringVar(&watchNamespace, "namespace", "", "Namespace to watch for Inbound resources. Empty means all namespaces.")
	...
	setupLog.Info("starting MetalLB platform controller")

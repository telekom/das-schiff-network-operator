...
ip link add vx.m2m type vxlan id 2002026 dev lo local 192.0.2.1 dstport 4789 nolearning
...
ip addr add fdff:965f:f02a:1::/127 dev m2mgw

# VRF c2m
ip link add vr.c2m type vrf table 2002027
ip link add vx.c2m type vxlan id 2002027 dev lo local 192.0.2.1 dstport 4789 nolearning
...
ip addr add fde9:9ec5:829e:1::/127 dev c2mgw

# Static routes to m2mgw/c2mgw
ip -4 route add 10.102.0.0/24 via inet6 fdff:965f:f02a:1::1 dev m2mgw vrf vr.m2m
ip -6 route add fda5:25c1:193c::/64 via inet6 fdff:965f:f02a:1::1 dev m2mgw vrf vr.m2m
ip -4 route add 10.102.1.0/24 via inet6 fde9:9ec5:829e:1::1 dev c2mgw vrf vr.c2m
ip -6 route add fda5:25c1:193d::/64 via inet6 fde9:9ec5:829e:1::1 dev c2mgw vrf vr.c2m

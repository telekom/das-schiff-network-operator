...
type AddResponse struct {
	...
	// (derived from WorkloadPort.interface, see workloadcni.TapIfaceName). For the
	// grout flavor the fast path creates a net_tap with this name in the CRA
	// netns; the CNI waits for it to appear and moves it into the pod netns (the
	// grout-tap handoff). For veth flavors the CNI already created the port, so

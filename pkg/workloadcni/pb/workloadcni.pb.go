...
const file_workloadcni_proto_rawDesc = "" +
	"\n" +
	"\x11workloadcni.proto\x12\x0eworkloadcni.v1\"\xeb\x01\n" +
	...
	"\x15layer2_attachment_ref\x18\x06 \x01(\v2#.workloadcni.v1.Layer2AttachmentRefR\x13layer2AttachmentRef\"\r\n" +
	"\vAddResponse\"M\n" +
	"\n" +
	"DelRequest\x12!\n" +
...
var file_workloadcni_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_workloadcni_proto_goTypes = []any{
	...
	(*AddRequest)(nil),          // 2: workloadcni.v1.AddRequest
	(*AddResponse)(nil),         // 3: workloadcni.v1.AddResponse
	(*DelRequest)(nil),          // 4: workloadcni.v1.DelRequest
	(*DelResponse)(nil),         // 5: workloadcni.v1.DelResponse
}
var file_workloadcni_proto_depIdxs = []int32{
	0, // 0: workloadcni.v1.AddRequest.port:type_name -> workloadcni.v1.WorkloadPort
	1, // 1: workloadcni.v1.AddRequest.layer2_attachment_ref:type_name -> workloadcni.v1.Layer2AttachmentRef
	2, // 2: workloadcni.v1.WorkloadCNI.Add:input_type -> workloadcni.v1.AddRequest
	4, // 3: workloadcni.v1.WorkloadCNI.Del:input_type -> workloadcni.v1.DelRequest
	3, // 4: workloadcni.v1.WorkloadCNI.Add:output_type -> workloadcni.v1.AddResponse
	5, // 5: workloadcni.v1.WorkloadCNI.Del:output_type -> workloadcni.v1.DelResponse

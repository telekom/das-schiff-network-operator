...
func (r *VrfIgbp) ReconcileLayer2(l2vnis []networkv1alpha1.Layer2NetworkConfigurationSpec) error {
...
func (r *VrfIgbp) getDesired(l2vnis []networkv1alpha1.Layer2NetworkConfigurationSpec) ([]nl.Layer2Information, error) {

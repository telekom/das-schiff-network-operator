...
const (
	Info_Info_FullMethodName = "/kubevirt.hooks.info.Info/Info"
)
...
func (UnimplementedInfoServer) Info(context.Context, *InfoParams) (*InfoResult, error) {
...
var Info_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/kubevirthook/pb/api_info.proto",
}

...
// GetCurrentConfigStatus mocks base method.
func (m *MockConfigInterface) GetCurrentConfigStatus() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCurrentConfigStatus")
	ret0, _ := ret[0].(string)
	return ret0
}

// GetCurrentConfigStatus indicates an expected call of GetCurrentConfigStatus.
func (mr *MockConfigInterfaceMockRecorder) GetCurrentConfigStatus() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCurrentConfigStatus", reflect.TypeOf((*MockConfigInterface)(nil).GetCurrentConfigStatus))
}
...
func (m *MockConfigInterface) Prune(arg0 context.Context, arg1 client.Client) error {
	m.ctrl.T.Helper()
...
func (mr *MockConfigInterfaceMockRecorder) Prune(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Prune", reflect.TypeOf((*MockConfigInterface)(nil).Prune), arg0, arg1)
}

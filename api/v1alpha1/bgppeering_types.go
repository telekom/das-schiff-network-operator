...
type BGPPeeringLoopback struct {
	// IPAddresses are the IP addresses of the loopback interface, one for IPv4 and/or one for IPv6
...
type BGPPeeringSpec struct {
	...
	PeeringVlan *BGPPeeringVLAN `json:"peeringVlan,omitempty"`
	...
	// Select nodes to create BGPPeering on

...
- Go dependencies are pinned via `go.mod` and kept up-to-date with security patches
- Container images are built on secure base images with pinned versions where supported
- Key runtime dependencies are pinned to specific versions, and tooling/test dependencies are regularly reviewed and updated
